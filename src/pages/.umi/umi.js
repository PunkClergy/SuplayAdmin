...
import findRoute, {
  getUrlQuery,
} from '/Users/chaojiwanka-web/Desktop/suplay-Admin/suplay-admin-ui/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/chaojiwanka-web/Desktop/suplay-Admin/suplay-admin-ui',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
