...
import { Form, Input, Modal, Upload, Select, Avatar, DatePicker, InputNumber } from 'antd';
  ...
  return (
    ...
    >
      <Form name="editProductForm" form={form} {...formLayout} initialValues={initialValues}>
        ...
        <Form.Item label="零售价" name="price" rules={[{ required: true, message: '请输入金额!' }]}>
          <InputNumber />
        </Form.Item>
        <Form.Item
          label="税率"
        ...
        <Form.Item
          label="批发价"
          name="wholesalePrice"
          rules={[{ required: true, message: '请输入批发价金额!' }]}
          extra="只在创建时设置，编辑无法更改"
        >
          <InputNumber />
        </Form.Item>
